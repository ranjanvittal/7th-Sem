...
public class NanoJavaParser implements NanoJavaParserConstants {
  ...
  static final public MethodDeclaration MethodDeclaration() throws ParseException {
   ...
   Token n20;
    ...
    n20 = jj_consume_token(RBRACE);
             n19 = JTBToolkit.makeNodeToken(n20);
     {if (true) return new MethodDeclaration(n0,n2,n4,n5,n7,n9,n11,n13,n15,n17,n19);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public JumpPoint JumpPoint() throws ParseException {
   NodeChoice n0;
   IfStatement n1;
   MessageSendStatement n2;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IF:
      n1 = IfStatement();
        n0 = new NodeChoice(n1, 0);
    ...
    default:
     ...
     {if (true) return new JumpPoint(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Statement Statement() throws ParseException {
   ...
   ArrayAssignmentStatement n2;
   PrintStatement n3;
    if (jj_2_6(2147483647)) {
      n1 = AssignmentStatement();
        n0 = new NodeChoice(n1, 0);
    } else if (jj_2_7(2147483647)) {
      n2 = ArrayAssignmentStatement();
        n0 = new NodeChoice(n2, 1);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case PRINT:
  ...
  static final public Block Block() throws ParseException {
   ...
   Token n6;
    ...
    n6 = jj_consume_token(RBRACE);
            n5 = JTBToolkit.makeNodeToken(n6);
     {if (true) return new Block(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1000000,0x10400200,0x1000000,0x80800000,0x0,0x80800000,0x0,0x80800000,0x20000000,0x0,0x80800000,0x20000000,0x0,0x10400200,0x10400200,0x0,0x10000000,0x400200,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0xcc2,0x0,0x800,0x4,0x800,0x4,0x800,0x800,0x4000,0x800,0x0,0x100,0xcc2,0xcc2,0x4000,0xcc0,0x2,0x800,};
   }
