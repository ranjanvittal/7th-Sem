...
public void micro_accept(micro_Visitor micro_v, extra_int return_value) {
int micro_nti;
micro_Visitor variable235;
extra_int variable236;
int variable237;
System.out.println(333);
variable235 = micro_v;
variable236 = new extra_int();
variable235.micro_visit(this, variable236);
variable237 = variable236.first;
micro_nti = variable237;
return_value.first = 0;
}
}
class micro_Visitor {
micro_Tree micro_l;
micro_Tree micro_r;
public void micro_visit(micro_Tree micro_n, extra_int return_value) {
int micro_nti;
micro_Tree variable238;
extra_boolean variable239;
boolean variable240;
micro_Tree variable241;
extra_micro_Tree variable242;
micro_Tree variable243;
micro_Tree variable244;
extra_int variable245;
int variable246;
micro_Tree variable247;
extra_boolean variable248;
boolean variable249;
micro_Tree variable250;
extra_micro_Tree variable251;
micro_Tree variable252;
micro_Tree variable253;
extra_int variable254;
int variable255;
variable238 = micro_n;
variable239 = new extra_boolean();
variable238.micro_GetHas_Right(variable239);
variable240 = variable239.first;
if(variable240){
{
variable241 = micro_n;
variable242 = new extra_micro_Tree();
variable241.micro_GetRight(variable242);
variable243 = variable242.first;
micro_r = variable243;
variable244 = micro_r;
variable245 = new extra_int();
variable244.micro_accept(this, variable245);
variable246 = variable245.first;
micro_nti = variable246;
}
}
else {
micro_nti = 0;
...
variable247 = micro_n;
variable248 = new extra_boolean();
variable247.micro_GetHas_Left(variable248);
variable249 = variable248.first;
if(variable249){
{
variable250 = micro_n;
variable251 = new extra_micro_Tree();
variable250.micro_GetLeft(variable251);
variable252 = variable251.first;
micro_l = variable252;
variable253 = micro_l;
variable254 = new extra_int();
variable253.micro_accept(this, variable254);
variable255 = variable254.first;
micro_nti = variable255;
}
}
else {
micro_nti = 0;
...
public void micro_visit(micro_Tree micro_n, extra_int return_value) {
int micro_nti;
micro_Tree variable256;
extra_boolean variable257;
boolean variable258;
micro_Tree variable259;
extra_micro_Tree variable260;
micro_Tree variable261;
micro_Tree variable262;
extra_int variable263;
int variable264;
micro_Tree variable265;
extra_int variable266;
int variable267;
micro_Tree variable268;
extra_boolean variable269;
boolean variable270;
micro_Tree variable271;
extra_micro_Tree variable272;
micro_Tree variable273;
micro_Tree variable274;
extra_int variable275;
int variable276;
variable256 = micro_n;
variable257 = new extra_boolean();
variable256.micro_GetHas_Right(variable257);
variable258 = variable257.first;
if(variable258){
{
variable259 = micro_n;
variable260 = new extra_micro_Tree();
variable259.micro_GetRight(variable260);
variable261 = variable260.first;
micro_r = variable261;
variable262 = micro_r;
variable263 = new extra_int();
variable262.micro_accept(this, variable263);
variable264 = variable263.first;
micro_nti = variable264;
}
}
else {
micro_nti = 0;
...
variable265 = micro_n;
variable266 = new extra_int();
variable265.micro_GetKey(variable266);
variable267 = variable266.first;
System.out.println(variable267);
variable268 = micro_n;
variable269 = new extra_boolean();
variable268.micro_GetHas_Left(variable269);
variable270 = variable269.first;
if(variable270){
{
variable271 = micro_n;
variable272 = new extra_micro_Tree();
variable271.micro_GetLeft(variable272);
variable273 = variable272.first;
micro_l = variable273;
variable274 = micro_l;
variable275 = new extra_int();
variable274.micro_accept(this, variable275);
variable276 = variable275.first;
micro_nti = variable276;
}
}
else {
micro_nti = 0;
