...
public class GJDepthFirst<R,A> implements GJVisitor<R,A> {
    ...
    class ClassInfo {
        public Hashtable<String, String> methods;
        public Hashtable<String, String> variables;
        public String parent;
        public ClassInfo(String parent) {
            methods = new Hashtable<String, String>();
            variables = new Hashtable<String, String>();
            this.parent = parent;
        }
        public void putMethod(String method, String type) {
            methods.put(method, type);
        }
        public String getMethod(String method) {
            if(methods.containsKey(method))
                return methods.get(method);
            return classInfos.get(parent).getMethod(method);
        }

        public void putVariable(String variable, String type) {
        ...
        public String getVariable(String variable) {
            ...
            return classInfos.get(parent).getVariable(variable);
        }
        public void pretty() {
    ...
    String className;
    Hashtable<String, ClassInfo> classInfos = new Hashtable<String, ClassInfo>();
    ...
    public R visit(ClassDeclaration n, A argu) {
        ...
        currentClassInfo = new ClassInfo(null);
        n.f2.accept(this, argu);
        n.f3.accept(this, argu);
        inClass = false;
        n.f4.accept(this, argu);
        n.f5.accept(this, argu);
        classInfos.put(className, currentClassInfo);
        return _ret;
    }
    ...
    public R visit(ClassExtendsDeclaration n, A argu) {
        ...
        currentClassInfo = new ClassInfo(parent);
        n.f4.accept(this, argu);
        n.f5.accept(this, argu);
        inClass = false;
        n.f6.accept(this, argu);
    ...
    public R visit(VarDeclaration n, A argu) {
        ...
        if(inClass) {
            ...
            currentClassInfo.putVariable(id, type);
        }
        return _ret;
    }
