/* Generated By:JavaCC: Do not edit this line. MicroJavaParser.java */
import syntaxtree.*;
...
public class MicroJavaParser implements MicroJavaParserConstants {
  ...
  static final public MainClass MainClass() throws ParseException {
   ...
   Token n47;
    ...
    n41 = jj_consume_token(RPAREN);
             n40 = JTBToolkit.makeNodeToken(n41);
    n43 = jj_consume_token(SEMICOLON);
             n42 = JTBToolkit.makeNodeToken(n43);
    n45 = jj_consume_token(RBRACE);
             n44 = JTBToolkit.makeNodeToken(n45);
    n47 = jj_consume_token(RBRACE);
             n46 = JTBToolkit.makeNodeToken(n47);
     {if (true) return new MainClass(n0,n2,n3,n5,n7,n9,n11,n13,n15,n17,n19,n21,n22,n24,n26,n28,n29,n31,n33,n35,n36,n38,n40,n42,n44,n46);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public MethodDeclaration MethodDeclaration() throws ParseException {
   ...
   Token n18;
    ...
    n18 = jj_consume_token(RBRACE);
             n17 = JTBToolkit.makeNodeToken(n18);
     {if (true) return new MethodDeclaration(n0,n2,n4,n5,n7,n9,n11,n13,n15,n17);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public MessageSendStatement MessageSendStatement() throws ParseException {
   ...
   Token n11;
    ...
    n11 = jj_consume_token(SEMICOLON);
     ...
     {if (true) return new MessageSendStatement(n0,n1,n3,n4,n6,n8,n10);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public VarRef VarRef() throws ParseException {
   NodeChoice n0;
   DotExpression n1;
   Identifier n2;
    if (jj_2_14(2)) {
     ...
     {if (true) return new VarRef(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public DotExpression DotExpression() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   Identifier n3;
    ...
    n2 = jj_consume_token(DOT);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = Identifier();
     {if (true) return new DotExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static public MicroJavaParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1000000,0x10400200,0x1000000,0x80800000,0x0,0x80800000,0x0,0x80800000,0x60002000,0x0,0x80800000,0x2000,0x60000000,0x60002000,0x10400200,0x10400200,0x0,0x10000000,0x400200,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0xcc2,0x0,0x800,0x4,0x800,0x4,0x800,0x900,0x4000,0x800,0x0,0x100,0x900,0xcc2,0xcc2,0x4000,0xcc0,0x2,0x800,};
   }
  ...
  public MicroJavaParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public MicroJavaParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new MicroJavaParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public MicroJavaParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public MicroJavaParser(MicroJavaParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(MicroJavaParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
